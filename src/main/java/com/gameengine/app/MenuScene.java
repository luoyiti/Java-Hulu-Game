...
public class MenuScene extends Scene {
    ...
    private MenuOption[] options = { MenuOption.START_GAME, MenuOption.OFFLINE_GAME, MenuOption.ONLINE_GAME,
            MenuOption.REPLAY, MenuOption.EXIT };
    ...
    private void switchToOfflineScene() {
        destroyScene();
        Scene offlineMenuScene = new OfflineMenuScene("Offline Menu Game", engine);
        engine.setScene(offlineMenuScene);
    ...
    private void renderMainMenu() {
        ...
        for (int i = 0; i < options.length; i++) {
            ...
            if (options[i] == MenuOption.START_GAME) {
                text = "▶ 开始游戏";
            } else if (options[i] == MenuOption.OFFLINE_GAME) {
                text = "▶ 本地多人";
