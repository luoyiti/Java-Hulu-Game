...
public class OnlineMenuScene extends Scene {
    ...
    public OnlineMenuScene(String name, GameEngine engine) {
        super(name);
        this.engine = engine;
    }
    ...
    public void render() {
        ...
        // 绘制标题 "请选择玩家人数"
        String title = "请选择玩家人数";
        renderer.drawText(title, 300, 196, 48, 0.15f, 0.15f, 0.2f, 1.0f);
    ...
    private void handleSelection() {
        ...
        destroyScene();
        // 菜单界面启动的都视作服务器
        OnlineGameScene onlineGameScene = new OnlineGameScene("葫芦娃网络对战游戏", engine, selectedPlayerCount, Status.SERVER);
        engine.setScene(onlineGameScene);
        System.out.println("选择了 " + selectedPlayerCount + " 名玩家");
    }
